document.addEventListener("scroll",function(){
    ...
    if(y >= 700 && y < 900){
        ...
        text_Change1.style.transition = "linear 0s"
        text_Change2.style.transition = "linear .75s"
        ...
        text_Change2.style.transition = "linear 0s"
        text_Change1.style.transition = "linear .75s"
